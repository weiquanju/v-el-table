...
<a href="https://www.npmjs.com/package/v-el-table">
    <img src="https://img.shields.io/badge/npm-0.1.0--rc.61-skyblue?logo=npm">
</a>
<a href="https://www.npmjs.com/package/v-el-table">
...
For auto import component, config the file `vite.config.ts` like this:
...
const configure: VElFormProps<Form> = reactive({
  form: {
    model: {
      name: 'v-el-table',
      components: 'small'
...
import type { TableColumn } from 'v-el-table/table/type'
import type { VElTablePlusProps } from 'v-el-table/table-plus/type'

type DataType = { id: number; value: string }

const tablePlusConfig = reactive<VElTablePlusProps>({
  title: '',
